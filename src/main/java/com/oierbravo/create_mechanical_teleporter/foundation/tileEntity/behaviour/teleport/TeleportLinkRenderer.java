...
public class TeleportLinkRenderer {
	...
	public static void tick() {
		...
		for (boolean first : Iterate.trueAndFalse) {
			AABB bb = new AABB(Vec3.ZERO, Vec3.ZERO).inflate(.20f);
	...
	public static void renderOnTileEntity(SmartTileEntity te, float partialTicks, PoseStack ms,
		...
		TeleportLinkBehaviour behaviour = te.getBehaviour(TeleportLinkBehaviour.TYPE);
		if (behaviour == null)
			return;
