...
/**
 * From AngelRing
 * https://github.com/DenisMasterHerobrine/AngelRing/blob/dev/3.0/1.21.1/common/src/main/java/dev/denismasterherobrine/angelring/utils/ExperienceUtils.java
 * License: MIT
 */
